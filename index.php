...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">
          ...
          <a href="Professor.php" class ="btn btn-primary">Entrar </a>
        </p>
      </main>

      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p>Escritório de Inovação e Tecnologia , by @BrenoFelix.</p>
        </div>
      </footer>
    </div>
    ...
    ================================================== -->
    <!-- Placed at the end of the document so the pages lo ad faster -->
